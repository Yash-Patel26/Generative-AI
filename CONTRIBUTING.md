...
This project has adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/?wt.mc_idstudentamb_409460).
For more information read the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/?wt.mc_idstudentamb_409460) or contact [opencode@microsoft.com](mailto:opencode@microsoft.com) with any additional questions or comments.
...
![VS code follow links screenshot](./images/vscode-follow-link.png?wt.mc_idstudentamb_409460 "Screenshot from vs code prompt to follow a link when you hover over a link.")
...
![VS code select relative path screenshot](./images/vscode-select-relative-path.png?wt.mc_idstudentamb_409460 "Screenshot from vs code prompt to select relative path from a pop up list.")
...
![GitHub check paths missing tracking comment screenshot](./images/github-check-paths-missing-tracking-comment.png?wt.mc_idstudentamb_409460 "Screenshot from github comment that shows missing tracking from relative paths")
...
![GitHub check urls missing tracking comment screenshot](./images/github-check-urls-missing-tracking-comment.png?wt.mc_idstudentamb_409460 "Screenshot from github comment that shows missing tracking from urls")
...
![GitHub check country locale comment screenshot](./images/github-check-country-locale-comment.png?wt.mc_idstudentamb_409460 "Screenshot from github comment that shows added country locale to urls")
