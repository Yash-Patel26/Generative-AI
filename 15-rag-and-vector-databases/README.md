...
[![Retrieval Augmented Generation (RAG) and Vector Databases](./images/15-lesson-banner.png?wt.mc_idstudentamb_409460)](https://aka.ms/gen-ai-lesson15-gh?wt.mc_idstudentamb_409460)
...
![drawing showing how RAGs work](images/how-rag-works.png?wt.mc_idstudentamb_409460)
...
Two approaches when implementing RAG according to the proposed paper: [Retrieval-Augmented Generation for Knowledge intensive NLP (natural language processing software) Tasks](https://arxiv.org/pdf/2005.11401.pdf?wt.mc_idstudentamb_409460) are:
