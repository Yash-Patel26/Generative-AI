...
[![Building Low Code AI Applications](./images/10-lesson-banner.png?wt.mc_id=studentamb_409460)](https://aka.ms/gen-ai-lesson10-gh?wt.mc_id=studentamb_409460)
...
1. Navigate to the [Power Apps](https://make.powerapps.com?wt.mc_id=studentamb_409460) home screen.
...
![Describe the app you want to build](./images/copilot-chat-prompt-powerapps.png?wt.mc_id=studentamb_409460)
...
1. The AI Copilot will suggest a Dataverse Table with the fields you need to store the data you want to track and some sample data. You can then customize the table to meet your needs using the AI Copilot assistant feature through conversational steps.
   ...
   ![Suggested fields in your new table](./images/copilot-dataverse-table-powerapps.png?wt.mc_id=studentamb_409460)
...
![Adding a new field](./images/copilot-new-column.png?wt.mc_id=studentamb_409460)
...
![Adding a new screen via a prompt instruction](./images/copilot-new-screen.png?wt.mc_id=studentamb_409460)
...
![Select new table](./images/describe-new-table.png?wt.mc_id=studentamb_409460)
...
![Describe the table](./images/copilot-chat-prompt-dataverse.png?wt.mc_id=studentamb_409460)

1. The AI Copilot will suggest a Dataverse Table with the fields you need to store the data you want to track and some sample data. You can then customize the table to meet your needs using the AI Copilot assistant feature through conversational steps.

![Suggested Dataverse table](./images/copilot-dataverse-table.png?wt.mc_id=studentamb_409460)
...
With Custom AI Models you can bring your own model into AI Builder so that it can function like any AI Builder custom model, allowing you to train the model using your own data. You can use these models to automate processes and predict outcomes in both Power Apps and Power Automate. When using your own model there are limitations that apply. Read more on these [limitations](https://learn.microsoft.com/ai-builder/byo-model#limitations?wt.mc_id=studentamb_409460).

![AI builder models](./images/ai-builder-models.png?wt.mc_id=studentamb_409460)
...
1. Navigate to the [Power Automate](https://make.powerautomate.com?wt.mc_id=studentamb_409460) home screen.
...
2. Use the text area on the home screen to describe the workflow you want to build. For example, **_Process an invoice when it arrives in my mailbox_**. Click on the **Send** button to send the prompt to the AI Copilot.
   ...
   ![Copilot power automate](./images/copilot-chat-prompt-powerautomate.png?wt.mc_id=studentamb_409460)
...
8. Remove the **Condition** action from the flow because you will not be using it. It should look like the following screenshot:
   ...
   ![power automate, remove actions](./images/powerautomate-remove-actions.png?wt.mc_id=studentamb_409460)
...
11. Select the **Table** you created earlier on. For example, you can select the **Invoice Information** table. Choose the dynamic content from the previous action to populate the following fields:
    ...
    ![power automate add row](./images/powerautomate-add-row.png?wt.mc_id=studentamb_409460)
...
![create a prompt](./images/create-prompt-gpt.png?wt.mc_id=studentamb_409460)

To learn how to use this AI Model in Power Automate, go through the [Add intelligence with AI Builder and GPT](https://learn.microsoft.com/training/modules/ai-builder-text-generation/?WT.mc_id=academic-409460-somelezediko) module.
...
Head over to Lesson 11 where we will look at how to [integrate Generative AI with Function Calling](../11-integrating-with-function-calling/README.md?wt.mc_id=studentamb_409460)!
