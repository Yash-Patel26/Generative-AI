...
![function flow](../../images/Function-Flow.png?wt.mc_id=studentamb_409460-yoterada)
...
![LLM Flow](../../images/LLM-Flow.png?wt.mc_id=studentamb_409460-yoterada)
...
ヒント: これらのデータを、どこでどのように利用できるかを確認するために、[Learn API リファレンス ドキュメント](https://learn.microsoft.com/training/support/catalog-api-developer-reference?wt.mc_id=studentamb_409460-yoterada) をご参照ください。
...
次のレッスン 12 では、[AI アプリケーション用の UX デザイン](../../../12-designing-ux-for-ai-applications/translations/ja-jp/README.md?wt.mc_id=studentamb_409460-yoterada)について学びます！
