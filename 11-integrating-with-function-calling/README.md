...
[![Integrating with function calling](./images/11-lesson-banner.png?wt.mc_id=studentamb_409460)](https://aka.ms/gen-ai-lesson11-gh?wt.mc_id=studentamb_409460)
...
> We recommend you to use the [included notebook](./python/aoai-assignment.ipynb?wt.mc_id=studentamb_409460) if you want to run the below scenario. You can also just read along as we're trying to illustrate a problem where functions can help to address the problem.
...
![function flow](./images/Function-Flow.png?wt.mc_id=studentamb_409460)
...
![LLM Flow](./images/LLM-Flow.png?wt.mc_id=studentamb_409460)
...
Hint: Follow the [Learn API reference documentation](https://learn.microsoft.com/training/support/catalog-api-developer-reference?wt.mc_id=studentamb_409460) page to see how and where this data is available.
...
Head over to Lesson 12 where we will look at how to [design UX for AI applications](../12-designing-ux-for-ai-applications/README.md?wt.mc_id=studentamb_409460)!
