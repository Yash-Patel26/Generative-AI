...
想要了解有关创建高级提示的更多信息？ 转至[进阶学习的页面](https://aka.ms/genai-collection?wt.mc_id=studentamb_409460-koreyst) 查找有关此主章节的其他学习资源。

前往第六章，我们将应用提示工程知识[构建文本生成应用程序](../../../06-text-generation-apps/translations/cn/README.md?wt.mc_id=studentamb_409460-koreyst)
