[![開放原始碼模型](../../images/17-lesson-banner.png?wt.mc_idstudentamb_409460)](https://aka.ms/gen-ai-lesson17-gh?wt.mc_idstudentamb_409460)
...
![代理模型](../../images/what-agent.png?wt.mc_idstudentamb_409460)
...
[LangChain Agents](https://python.langchain.com/docs/how_to/#agents?wt.mc_idstudentamb_409460) 是我們上述定義的實現。
...
LangChain 提供一個[工具目錄](https://integrations.langchain.com/tools?wt.mc_idstudentamb_409460)，可以匯入到您的應用程式中，LLM 可以存取這些工具。這些工具由社群和 LangChain 團隊製作。
...
下一個我們將討論的 AI Agent 框架是 [AutoGen](https://microsoft.github.io/autogen/?wt.mc_idstudentamb_409460)。AutoGen 的主要焦點是對話。Agents 既是**可對話的**也是**可定制的**。
...
你可以找到[AutoGen 程式碼範例](https://microsoft.github.io/autogen/docs/Examples/?wt.mc_idstudentamb_409460)來進一步探索如何開始建構。

## Taskweaver

接下來我們將探討的代理框架是 [Taskweaver](https://microsoft.github.io/TaskWeaver/?wt.mc_idstudentamb_409460)。它被稱為「程式碼優先」代理，因為它不僅僅是嚴格地與 `strings` 一起工作，它還可以與 Python 中的 DataFrames 一起工作。這對於資料分析和生成任務變得非常有用。這可以是建立圖表或生成隨機數等事情。
...
最後我們將探討的代理框架是 [JARVIS](https://github.com/microsoft/JARVIS?tab=readme-ov-file?wt.mc_idstudentamb_409460)。JARVIS 的獨特之處在於它使用 LLM 來管理對話的 `state`，而 `tools` 是其他 AI 模型。每個 AI 模型都是專門的模型，執行某些任務，例如物件檢測、轉錄或圖像標註。
