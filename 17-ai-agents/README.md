[![Open Source Models](./images/17-lesson-banner.png?wt.mc_idstudentamb_409460)](https://aka.ms/gen-ai-lesson17-gh?wt.mc_idstudentamb_409460)
...
![Agent Model](images/what-agent.png?wt.mc_idstudentamb_409460)
...
[LangChain Agents](https://python.langchain.com/docs/how_to/#agents?wt.mc_idstudentamb_409460) is an implementation of the definitions we provided above.
...
![Langchain Agents](images/langchain-agents.png?wt.mc_idstudentamb_409460)

LangChain offers a [catalog of tools](https://integrations.langchain.com/tools?wt.mc_idstudentamb_409460) that can be imported into your application in which the LLM can get access to. These are made by the community and by the LangChain team.
...
The next AI Agent framework we will discuss is [AutoGen](https://microsoft.github.io/autogen/?wt.mc_idstudentamb_409460). The main focus of AutoGen is conversations. Agents are both **conversable** and **customizable**.
...
![AutoGen](images/autogen.png?wt.mc_idstudentamb_409460)
...
You can find a list of [AutoGen code samples](https://microsoft.github.io/autogen/docs/Examples/?wt.mc_idstudentamb_409460) to further explore how to get started building.

## Taskweaver

The next agent framework we will explore is [Taskweaver](https://microsoft.github.io/TaskWeaver/?wt.mc_idstudentamb_409460). It is known as a "code-first" agent because instead of working strictly with `strings` , it can work with DataFrames in Python. This becomes extremely useful for data analysis and generation tasks. This can be things like creating graphs and charts or generating random numbers.
...
![Taskweaver](images/taskweaver.png?wt.mc_idstudentamb_409460)
...
The last agent framework we will explore is [JARVIS](https://github.com/microsoft/JARVIS?tab=readme-ov-file?wt.mc_idstudentamb_409460). What makes JARVIS unique is that it uses an LLM to manage the `state` of the conversation and the `tools`are other AI models. Each of the AI models are specialized models that perform certain tasks such as object detection, transcription or image captioning.

![JARVIS](images/jarvis.png?wt.mc_idstudentamb_409460)
